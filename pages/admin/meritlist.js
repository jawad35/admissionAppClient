...
import { Grid, Avatar, TextField, Typography, Link, Box, Button } from '@material-ui/core'
...
export default function Admin() {
    ...
    //         }
    //     }
    //     axios.get(`GetContacts`, axiosConfig)
    //         .then((res) => {
    //             if (res.data.ShowMsg) {
            ...
            <div className={styles.container}>
                ...
                <div className={styles.contentcontainer}>
                    <div>
                        ...
                        <div>
                            <Button onClick={hadnleCreateAdmin} variant="contained" style={{ margin: '10px', background: '#FF0000', color:'white' }}>Delete</Button>
                        </div>
                    </div>
